...
ELECTIONS = {
    ...
    "2018": {
        "election": "National Assembly of Armenia — snap election, 9 December 2018",
        "date": "2018-12-09",
        "election_id": 27576,
        "threshold_party_pct": 5.0,
        "threshold_alliance_pct": 7.0,
        "total_seats": 132,
        "col_inaccuracy": 26,
        # The first post-revolution snap vote still used the pre-reform communities.
        # Re-aggregate to the modern consolidated municipalities (as 2017/2021).
        "consolidate_from": "2026",
        "seats": {"my_step": 88, "prosperous_armenia": 26, "bright_armenia": 18},
        "parties": [
            (18, "my_step", "alliance",
             "«Իմ քայլը» դաշինք", "My Step Alliance", "Alliance « Mon pas »",
             "ԻՔԴ / MS", "Nikol Pashinyan", "government", "liberal-reformist", "#F58220"),
            (25, "prosperous_armenia", "party",
             "«Բարգավաճ Հայաստան» կուսակցություն", "Prosperous Armenia", "Arménie prospère",
             "ԲՀԿ / PA", "Gagik Tsarukyan", "opposition", "centrist-populist", "#E8A300"),
            (19, "bright_armenia", "party",
             "«Լուսավոր Հայաստան» կուսակցություն", "Bright Armenia", "Arménie lumineuse",
             "ԼՀԿ / BA", "Edmon Marukyan", "opposition", "liberal", "#4895EF"),
            (15, "republican", "party",
             "Հայաստանի Հանրապետական կուսակցություն", "Republican Party of Armenia", "Parti républicain d’Arménie",
             "ՀՀԿ / RPA", "Serzh Sargsyan", "below-threshold", "national-conservative", "#2D5DA1"),
            (17, "arf", "party",
             "«Հայ յեղափոխական դաշնակցություն» կուսակցություն", "Armenian Revolutionary Federation (Dashnaktsutyun)", "Fédération révolutionnaire arménienne (Dachnaktsoutioun)",
             "ՀՅԴ / ARF", "Armen Rustamyan", "below-threshold", "socialist-nationalist", "#C8102E"),
            (22, "we_alliance", "alliance",
             "«Մենք» դաշինք", "We Alliance", "Alliance « Nous »",
             "Մենք / We", "Aram Sargsyan", "below-threshold", "liberal-conservative", "#0F8B8D"),
            (24, "sasna_tsrer", "party",
             "«Սասնա ծռեր» համահայկական կուսակցություն", "Sasna Tsrer Pan-Armenian Party", "Sasna Tsrer (parti panarménien)",
             "ՍԾ / ST", None, "below-threshold", "radical-nationalist", "#6A4C93"),
            (23, "orinats_yerkir", "party",
             "«Օրինաց երկիր» կուսակցություն", "Orinats Yerkir (Rule of Law)", "Orinats Yerkir (État de droit)",
             "ՕԵ / RoL", "Artur Baghdasaryan", "below-threshold", "conservative", "#48BFE3"),
            (16, "citizens_decision", "party",
             "«Քաղաքացու որոշում» սոցիալ-դեմոկրատական կուսակցություն", "Citizen’s Decision Social-Democratic Party", "Parti social-démocrate « Décision citoyenne »",
             "ՔՈ / CD", None, "below-threshold", "social-democratic", "#B5838D"),
            (20, "christian_democratic_rebirth", "party",
             "«Քրիստոնեա-ժողովրդական վերածնունդ» կուսակցություն", "Christian-Democratic Rebirth", "Renaissance chrétienne-démocrate",
             "ՔԺՎ / CDR", None, "below-threshold", "christian-democratic", "#B08968"),
            (21, "national_progress", "party",
             "«Ազգային առաջընթաց» կուսակցություն", "National Progress Party", "Parti du progrès national",
